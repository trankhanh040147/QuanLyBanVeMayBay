namespace DataAccessLayer.Migrations
{
    ...
    public partial class official : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.DuongBay", t => t.MaDuongBay, cascadeDelete: true)
                .ForeignKey("dbo.MayBay", t => t.MaMayBay, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        MaVeBan = c.String(nullable: false, maxLength: 100, unicode: false),
                        MaVe = c.String(nullable: false, maxLength: 10, unicode: false),
                ...
                .ForeignKey("dbo.ThongTinChiTietVe", t => t.MaVe, cascadeDelete: true)
                .Index(t => t.MaVe)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.VeBan", t => t.MaVeBan, cascadeDelete: true)
                .Index(t => t.MaVeBan);
