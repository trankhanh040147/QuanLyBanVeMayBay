...
namespace BussinessLogicLayer
{
    public class DbNhanVien
    {
        ...
        public bool checkNhanVien_thongtindangnhap(string tendangnhap, string matkhau)
        {
            var dsNhanVien = dbs.NhanViens.Where(p => p.TenDangNhap == tendangnhap).FirstOrDefault();    
            if (dsNhanVien != null)
                if (dsNhanVien.MatKhau == matkhau)            
                    return true;
            return false;
        }
