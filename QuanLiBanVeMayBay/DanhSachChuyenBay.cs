...
namespace QuanLyBanVeMayBay
{
    public partial class DanhSachChuyenBay : Form
    {
        ...
        private void DataBind()
        {
            ...
            txtTim.DataBindings.Add("Text", ds.Tables[0], "Mã chuyến bay");
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DialogResult tl = MessageBox.Show("Bạn muốn xóa chuyến bay khỏi CSDL?", "Xóa",
                       MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (tl == DialogResult.Yes)
                {
                    ChuyenBay cb = new ChuyenBay();
                    cb.MaChuyenBay = txtTim.Text;
                    if (!db.deleteChuyenBay(ref err, cb))
        ...
        {
            CapNhatChuyenBay cncb = new CapNhatChuyenBay();
            cncb.Show();
        }
